...
//        number[3]=25;//{10,4,5 ,25};ArrayIndexOutOfBoundsException
        ...
        //to string method will ask and array and convert that array to string
        ...
        System.out.println(names);//[java.lang.String;@6e0be858
        ...
        //since list3 is empty which we didn't assigned anything .
        //all list as a default will be 0
