...
public class c1_Arrays {
    public static void main(String[] args) {
        ...
        //this will be size 4 string array
        //and all index are empty
        //as a default those index will be null for string

        System.out.println(engineers[1]); // null
        System.out.println(engineers[3]); // null
        engineers[1] ="Serhat"; // this will be serhat not null anymore
        //reassigned from null to serhat
