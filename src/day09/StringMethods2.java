...
public class StringMethods2 {
    ...
    public static void main(String[] args) {
        ...
        // you cant replace integer number replace methods coming from string classes
        ...
        //print false if string doesn't start with Java 21 and if doesn't and with 47 Java
